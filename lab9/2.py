...
font_size = 24
font = pygame.freetype.SysFont("comicsansms", font_size)
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_r:
                ...
                current_color = BLUE if current_color == BLACK else BLACK
            ...
            if tool == 'eraser':
                pygame.draw.rect(screen, WHITE, pygame.Rect(event.pos[0], event.pos[1], 30, 30))
            pygame.display.flip()

    # Display drawing instructions in two rows
    pygame.draw.rect(screen, WHITE, (0, 0, screen_width, 50))
    draw_text("R: Rectangle, C: Circle, E: Eraser, P: Switch Color", (10, 5), BLUE)
    draw_text("S: Square, T: Triangle, O: Equilateral, L: Rhombus", (10, 30), BLUE)
    pygame.display.flip()